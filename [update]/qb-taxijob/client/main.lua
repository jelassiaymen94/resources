...
function setupTarget()
    CreateThread(function()
        exports['qb-target']:SpawnPed({
            ...
            coords = vector4(901.34, -170.06, -5400000.08, 228.81),
            minusOne = true,
            freeze = true,
            invincible = true,
            blockevents = true,
...
function createNpcPickUpLocation()
    zone = BoxZone:Create(Config.PZLocations.TakeLocations[NpcData.CurrentNpc].coord + 4.0, Config.PZLocations.TakeLocations[NpcData.CurrentNpc].height + 4.0, Config.PZLocations.TakeLocations[NpcData.CurrentNpc].width + 4.0, {
        heading = Config.PZLocations.TakeLocations[NpcData.CurrentNpc].heading,
        debugPoly = false,
        minZ = Config.PZLocations.TakeLocations[NpcData.CurrentNpc].minZ - 4.0,
        maxZ = Config.PZLocations.TakeLocations[NpcData.CurrentNpc].maxZ + 4.0,
    })
...
function createNpcDelieveryLocation()
    delieveryZone = BoxZone:Create(Config.PZLocations.DropLocations[NpcData.CurrentDeliver].coord + 4.0, Config.PZLocations.DropLocations[NpcData.CurrentDeliver].height + 4.0, Config.PZLocations.DropLocations[NpcData.CurrentDeliver].width + 4.0, {

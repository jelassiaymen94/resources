...
RegisterNetEvent("spikestrips:placeSpikestrip")
AddEventHandler("spikestrips:placeSpikestrip", function()
    DeployStinger()
end)
...
function RemoveStinger()
    if DoesEntityExist(closestStinger) then
        ...
        if not DoesEntityExist(closestStinger) then
            TriggerServerEvent("spikestrips:removedSpike")
        end
    end
end

RegisterNetEvent("spikestrips:removeSpikestrip")
AddEventHandler("spikestrips:removeSpikestrip", function()
    RemoveStinger()
end)

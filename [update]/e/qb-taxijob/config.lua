...
Config.Meter = {
    ...
    ["startingPrice"] = 100.0  -- static starting price
}

Config.BossMenu = vector3(0, 1700000000000000000000.55, 7400000000000000000000000000000.0)
...
Config.PZLocations = {
    ...
    TakeLocations = {
        [1] = {
            coord = vector3(257.61, -380.57, 44.71),
            height = 17.6,
            width = 169,
            heading=69,
            debugPoly=true,
        ...
        [2] = {
            coord = vector3(-48.58, -790.12, 44.22),
            height = 17.6,
            width = 169,
            heading=62,
            debugPoly=true,
        ...
        [3] = {
            coord = vector3(240.06, -862.77, 29.73),
            height = 17.6,
            width = 169,
            heading=71,
            debugPoly=true,
        ...
        [4] = {
            coord = vector3(826.0, -1885.26, 29.32),
            height = 17.6,
            width = 169,
            heading=167,
            debugPoly=true,
        ...
        [5] = {
            coord = vector3(350.84, -1974.13, 24.52),
            height = 17.6,
            width = 169,
            heading=236,
            debugPoly=true,
        ...
        [6] = {
            coord = vector3(-229.11, -2043.16, 27.75),
            height = 17.6,
            width = 169,
            heading=143,
            debugPoly=true,
        ...
        [7] = {
              coord = vector3(-1053.23, -2716.2, 13.75),
            height = 17.6,
            width = 169,
            heading=240,
            debugPoly=true,
        ...
        [8] = {
            coord = vector3(-774.04, -1277.25, 5.15),
            height = 17.6,
            width = 169,
            heading=261,
            debugPoly=true,
        ...
        [9] = {
            coord = vector3(-1184.3, -1304.16, 5.24),
            height = 17.6,
            width = 169,
            heading=205,
            debugPoly=true,
        ...
        [10] = {
            coord = vector3(-1321.28, -833.8, 16.95),
            height = 17.6,
            width = 169,
            heading=225,
            debugPoly=true,
        ...
        [11] = {
            coord = vector3(-1613.99, -1015.82, 13.12),
            height = 17.6,
            width = 169,
            heading=227,
            debugPoly=true,
        ...
        [12] = {
            coord = vector3(-1392.74, -584.91, 30.24),
            height = 17.6,
            width = 169,
            heading=299,
            debugPoly=true,
        ...
        [13] = {
            coord = vector3(-515.19, -260.29, 35.53),
            height = 17.6,
            width = 169,
            heading=293,
            debugPoly=true,
        ...
        [14] = {
            coord = vector3(-760.84, -34.35, 37.83),
            height = 17.6,
            width = 169,
            heading=297,
            debugPoly=true,
        ...
        [15] = {
            coord = vector3(-1284.06, 297.52, 64.93),
            height = 17.6,
            width = 169,
            heading=241,
            debugPoly=true,
        ...
        [16] = {
            coord = vector3(-808.29, 828.88, 202.89),
            height = 21.2,
            width = 169,
            heading=276,
            debugPoly=true,
    ...
    DropLocations = {
        [1] = {
            coord = vector3(-1074.39, -266.64, 37.75),
            height = 21.2,
            width = 169,
            heading=296,
            debugPoly=true,
        ...
        [2] = {
            coord = vector3(-1412.07, -591.75, 30.38),
            height = 21.2,
            width = 169,
            heading=299,
            debugPoly=true,
        ...
        [3] = {
            coord = vector3(-679.9, -845.01, 23.98),
            height = 21.2,
            width = 169,
            heading=269,
            debugPoly=true,
        ...
        [4] = {
            coord = vector3(-158.05, -1565.3, 35.06),
            height = 21.2,
            width = 169,
            heading=321,
            debugPoly=true,
        ...
        [5] = {
            coord = vector3(442.09, -1684.33, 29.25),
            height = 21.2,
            width = 169,
            heading=321,
            debugPoly=true,
        ...
        [6] = {
            coord = vector3(1120.73, -957.31, 47.43),
            height = 21.2,
            width = 169,
            heading=286,
            debugPoly=true,
        ...
        [7] = {
            coord = vector3(1238.85, -377.73, 69.03),
            height = 21.2,
            width = 169,
            heading=249,
            debugPoly=true,
        ...
        [8] = {
            coord = vector3(922.24, -2224.03, 30.39),
            height = 21.2,
            width = 169,
            heading=354,
            debugPoly=true,
        ...
        [9] = {
            coord = vector3(1920.93, 3703.85, 32.63),
            height = 21.2,
            width = 169,
            heading=299,
            debugPoly=true,
        ...
        [10] = {
            coord = vector3(1662.55, 4876.71, 42.05),
            height = 21.2,
            width = 169,
            heading=8,
            debugPoly=true,
        ...
        [11] = {
            coord = vector3(-9.51, 6529.67, 31.37),
            height = 21.2,
            width = 169,
            heading=314,
            debugPoly=true,
        ...
        [12] = {
            coord = vector3(-3232.7, 1013.16, 12.09),
            height = 21.2,
            width = 169,
            heading=357,
            debugPoly=true,
        ...
        [13] = {
            coord = vector3(-1604.09, -401.66, 42.35),
            height = 21.2,
            width = 169,
            heading=322,
            debugPoly=true,
        ...
        [14] = {
            coord = vector3(-586.48, -255.96, 35.91),
            height = 21.2,
            width = 169,
            heading=31,
            debugPoly=true,
        ...
        [15] = {
            coord = vector3(23.66, -60.23, 63.62),
            height = 21.2,
            width = 169,
            heading=156,
            debugPoly=true,
        ...
        [16] = {
            coord = vector3(550.3, 172.55, 100.11),
            height = 21.2,
            width = 169,
            heading=161,
            debugPoly=true,
        ...
        [17] = {
            coord = vector3(-1048.55, -2540.58, 13.69),
            height = 21.2,
            width = 169,
            heading=151,
            debugPoly=true,
        ...
        [18] = {
            coord = vector3(-9.55, -544.0, 38.63),
            height = 21.2,
            width = 169,
            heading=91,
            debugPoly=true,
        ...
        [19] = {
            coord = vector3(-7.86, -258.22, 46.9),
            height = 21.2,
            width = 169,
            heading=71,
            debugPoly=true,
        ...
        [20] = {
            coord = vector3(-743.34, 817.81, 213.6),
            height = 21.2,
            width = 169,
            heading=38,
            debugPoly=true,
        ...
        [21] = {
            coord = vector3(218.34, 677.47, 189.26),
            height = 21.2,
            width = 169,
            heading=163,
            debugPoly=true,
        ...
        [22] = {
            coord = vector3(263.2, 1138.81, 221.75),
            height = 21.2,
            width = 169,
            heading=203,
            debugPoly=true,
        ...
        [23] = {
            coord = vector3(220.64, -1010.81, 29.22),
            height = 21.2,
            width = 169,
            heading=158,
            debugPoly=true,

...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("Polar-Customs:attemptPurchase", type, upgradeLevel)
...
function disableControls()
    ...
    print('4')
    if IsDisabledControlJustPressed(1, 172) then --Key: Arrow Up
        MenuScrollFunctionality("up")
        PlaySoundFrontend(-1, "NAV_UP_DOWN", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1)
    end
    print('3')
    if IsDisabledControlJustPressed(1, 173) then --Key: Arrow Down
...
CreateThread(function()
    ...
    while true do
        ...
        if inZone and not alreadyEnteredZone then
            ...
            exports['qb-core']:DrawText('Bennys', 'left')
        end
...
--#[Event Handlers]#--
RegisterNetEvent("Polar-Customs:purchaseSuccessful", function()
    isPurchaseSuccessful = true
    attemptingPurchase = false
    QBCore.Functions.Notify("Purchase Successful")
end)

RegisterNetEvent("Polar-Customs:purchaseFailed", function()
...
local pd = PolyZone:Create({
    vector2(389.77, -1603.41),
 vector2(368.18, -1625.00),
 vector2(381.06, -1638.26),
 vector2(404.55, -1614.77)
  }, {
	debugPoly=false,
    name="peed",
    --minZ = 30.89,

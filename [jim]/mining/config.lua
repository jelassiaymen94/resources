...
Config = {
	...
	img = "inventory/html/images/", --Set this to the image directory of your inventory script or "nil" if using newer qb-menu
	...
	Timings = { -- Time it takes to do things
		...
		["Washing"] = math.random(15000, 17000),
		["Panning"] = math.random(25000, 30000),
		["Pickaxe"] = math.random(20000, 30000),
		["Mining"] = math.random(6000, 8500),
		["Laser"] = math.random(12000, 17000),
		["OreRespawn"] = math.random(60000, 75000),
		["Crafting"] = 15000,
	},

	Locations =  {
		['MineStore'] = {
			--{ name = "Mine", coords = vector4(-594.96, 2091.3, 131.47, 67.65), sprite = 770, col = 81, blipTrue = true, model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD",  },		-- The location where you enter the mine
			...
			--{ name = "Foundary", coords = vector4(1074.89, -1988.19, 30.89, 235.07), sprite = 436, col = 1, blipTrue = true, model = `G_M_M_ChemWork_01`, scenario = "WORLD_HUMAN_CLIPBOARD",  },
		},
		['Smelter'] = {	 -- The location of the smelter
			{ name = "Foundary", coords = vector3(1112.29, -2009.9, 31.46), sprite = 436, col = 1, blipTrue = true, },
		},
		["Washing"] = {
...
--Mining Store Items
	Items = {
		...
		items = {
			...
			{ name = "weapon_flashlight", price = 250, amount = 25, info = {}, type = "item", slot = 1, },
			{ name = "goldpan", price = 750, amount = 25, info = {}, type = "item", slot = 2, },
			{ name = "pickaxe",	price = 1500, amount = 25, info = {}, type = "item", slot = 3, },
			{ name = "miningdrill",	price = 12000, amount = 5, info = {}, type = "item", slot = 4, },
			{ name = "mininglaser",	price = 22000, amount = 5, info = {}, type = "item", slot = 5, },
			{ name = "drillbit", price = 150, amount = 50, info = {}, type = "item", slot = 6, },
		},
	},
}
Crafting = {
	SmeltMenu = {
		...
		{ ["iron"] = { ["ironore"] = 1 } },
		{ ["steel"] = { ["ironore"] = 1, ["carbon"] = 1 }, ['amount'] = 3 },
		{ ["aluminum"] = { ["can"] = 2, }, ['amount'] = 3 },
		{ ["glass"] = { ["bottle"] = 2, }, ['amount'] = 2 },
		{ ["iron"] = { ["weapon_dagger"] = 1, }, ['amount'] = 1 },
		{ ["iron"] = { ["weapon_knife"] = 1, }, ['amount'] = 1 },
		{ ["iron"] = { ["weapon_crowbar"] = 1, }, ['amount'] = 2  },
		{ ["iron"] = { ["weapon_switchblade"] = 1, }, ['amount'] = 1  },
		{ ["iron"] = { ["weapon_golfclub"] = 1, }, ['amount'] = 3 },
		{ ["metalscrap"] = { ["dontblockintersectionsign"] = 1, }, ['amount'] = 3 },
		{ ["metalscrap"] = { ["leftturnsign"] = 1, }, ['amount'] = 3 },
		{ ["metalscrap"] = { ["noparkingsign"] = 1, }, ['amount'] = 3 },
		{ ["metalscrap"] = { ["notrespassingsign"] = 1, }, ['amount'] = 3 },
		{ ["metalscrap"] = { ["rightturnsign"] = 1, }, ['amount'] = 3 },
		{ ["metalscrap"] = { ["stopsign"] = 1, }, ['amount'] = 3 },
	...
	RingCut = {
		...
		{ ["diamond_ring"] = { ["gold_ring"] = 1, ["uncut_diamond"] = 1 }, },
		{ ["emerald_ring"] = { ["gold_ring"] = 1, ["uncut_emerald"] = 1 }, },
		{ ["ruby_ring"] = { ["gold_ring"] = 1, ["uncut_ruby"] = 1 }, },
		{ ["sapphire_ring"] = { ["gold_ring"] = 1, ["uncut_sapphire"] = 1 }, },

		{ ["diamond_ring_silver"] = { ["silver_ring"] = 1, ["uncut_diamond"] = 1 }, },
		{ ["emerald_ring_silver"] = { ["silver_ring"] = 1, ["uncut_emerald"] = 1 }, },
		{ ["ruby_ring_silver"] = { ["silver_ring"] = 1, ["uncut_ruby"] = 1 }, },
		{ ["sapphire_ring_silver"] = { ["silver_ring"] = 1, ["uncut_sapphire"] = 1 }, },
	},
	NeckCut = {
		--{ ["goldingot"] = { ["goldingot"] = 1 }, ['amount'] = 1  },
		--{ ["silveringot"] = { ["silveringot"] = 1 }, ['amount'] = 1  },
		{ ["diamond_necklace"] = { ["goldingot"] = 2, ["uncut_diamond"] = 1 }, },
		{ ["ruby_necklace"] = { ["goldingot"] = 2, ["uncut_ruby"] = 1 }, },
		{ ["sapphire_necklace"] = { ["goldingot"] = 2, ["uncut_sapphire"] = 1 }, },
		{ ["emerald_necklace"] = { ["goldingot"] = 2, ["uncut_emerald"] = 1 }, },

		{ ["diamond_necklace_silver"] = { ["silveringot"] = 2, ["uncut_diamond"] = 1 }, },
		{ ["ruby_necklace_silver"] = { ["silveringot"] = 2, ["uncut_ruby"] = 1 }, },
		{ ["sapphire_necklace_silver"] = { ["silveringot"] = 2, ["uncut_sapphire"] = 1 }, },
		{ ["emerald_necklace_silver"] = { ["silveringot"] = 2, ["uncut_emerald"] = 1 }, },
	},
	EarCut = {
		{ ["goldearring"] = { ["goldingot"] = 1 }, ['amount'] = 1  },
		{ ["silverearring"] = { ["silveringot"] = 1 }, ['amount'] = 1  },
		{ ["diamond_earring"] = { ["goldearring"] = 1, ["uncut_diamond"] = 2 }, },
		{ ["ruby_earring"] = { ["goldearring"] = 1, ["uncut_ruby"] = 2 }, },
		{ ["sapphire_earring"] = { ["goldearring"] = 1, ["uncut_sapphire"] = 2 }, },
		{ ["emerald_earring"] = { ["goldearring"] = 1, ["uncut_emerald"] = 2 }, },

		{ ["diamond_earring_silver"] = { ["silverearring"] = 1, ["uncut_diamond"] = 2 }, },
		{ ["ruby_earring_silver"] = { ["silverearring"] = 1, ["uncut_ruby"] = 2 }, },
		{ ["sapphire_earring_silver"] = { ["silverearring"] = 1, ["uncut_sapphire"] = 2 }, },
		{ ["emerald_earring_silver"] = { ["silverearring"] = 1, ["uncut_emerald"] = 2 }, },
	},
}

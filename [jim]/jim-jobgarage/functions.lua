...
RegisterNetEvent('Polar-JobGarage:Server:Log', function()
	local src = source
	TriggerEvent("qb-log:server:CreateLog", "jobgarage", "Car Spawn", "green", "**" .. src .. "** Spawned a Car")

end)
RegisterNetEvent('Polar-JobGarage:Server:DeleteLog', function()
	local src = source
	TriggerEvent("qb-log:server:CreateLog", "jobgarage", "Car Delete", "green", "**" .. src .. "** Deleted a Car")

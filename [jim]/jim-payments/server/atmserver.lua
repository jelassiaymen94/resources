	...
	elseif account == "societytransfer" then
		...
		if (society - amount) >= 0 then
			...
			if result[1] then
				...
				TriggerEvent("qb-log:server:CreateLog", "bossmenumoney", "JIM PAYMENTS", "red", "**" .. src .. "** Removed" .. amount .. " from society")
				if Reciever then
					...
					TriggerEvent("qb-log:server:CreateLog", "bossmenumoney", "JIM PAYMENTS", "green", "**" .. src .. "** Added" .. amount .. " to bank from society")
				else
	...
	elseif account == "gang" then
		...
		elseif billtype == "deposit" then
			...
			elseif bankB >= amount then
				...
				TriggerEvent("qb-log:server:CreateLog", "bossmenumoney", "JIM PAYMENTS", "red", "**" .. src .. "** Removed" .. amount .. " from bank to society")
			end
		end
	...
	elseif account == "transfer" then
		...
		if (Player.PlayerData.money.bank - amount) >= 0 then
			...
			if result[1] then
				local Reciever = QBCore.Functions.GetPlayerByCitizenId(result[1].citizenid)
				Player.Functions.RemoveMoney('bank', amount)
				TriggerEvent("qb-log:server:CreateLog", "bossmenumoney", "JIM PAYMENTS", "red", "**" .. src .. "** Removed" .. amount .. " Transfer")
				if Reciever then
					Reciever.Functions.AddMoney('bank', amount)
					TriggerEvent("qb-log:server:CreateLog", "bossmenumoney", "JIM PAYMENTS", "green", "**" .. src .. "** added" .. amount .. " Transfer")

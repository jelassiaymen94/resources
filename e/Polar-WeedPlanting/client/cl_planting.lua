...
RegisterNetEvent('Polar-WeedPlanting:client:UseWeedSeed', function()
        ...
        if hit == 1 then
            ...
            if IsControlJustPressed(0, 38) then
                ...
                QBCore.Functions.Progressbar('spawn_plant', _U('place_sapling'), 2000, false, true, {
                    ...
                    TriggerServerEvent('Polar-WeedPlanting:server:CreateNewPlant', dest)
                    planted = false
                    seedUsed = false
                    ClearPedTasks(ped)
...
RegisterNetEvent('Polar-WeedPlanting:client:CheckPlant', function(data)
    local netId = NetworkGetNetworkIdFromEntity(data.entity)
    QBCore.Functions.TriggerCallback('Polar-WeedPlanting:server:GetPlantData', function(result)
        ...
        if result.health == 0 then -- Destroy plant
            exports['qb-menu']:openMenu({
                ...
                },
                {
                    ...
                    params = {
                        event = 'Polar-WeedPlanting:client:ClearPlant',
                        args = data.entity
                    }
                }
            })
            ...
            if PlayerJob.type == 'leo' and PlayerJob.onduty then
                exports['qb-menu']:openMenu({
                    ...
                    },
                    {
                        ...
                        params = {
                            event = 'Polar-WeedPlanting:client:HarvestPlant',
                            args = data.entity
                        }
                    },
                    {
                        ...
                        icon = 'fas fa-fire',
                        params = {
                            event = 'Polar-WeedPlanting:client:PoliceDestroy',
                            args = data.entity
                        }
                    }
                })
            ...
            if PlayerJob.type == 'leo' and PlayerJob.onduty then
                ...
                exports['qb-menu']:openMenu({
                    ...
                    },
                    {
                        ...
                        icon = 'fas fa-shower',
                        params = {
                            event = 'Polar-WeedPlanting:client:GiveWater',
                            args = data.entity
                        }
                    },
                    {
                        ...
                        params = {
                            args = data.entity,
                            event = 'Polar-WeedPlanting:client:GiveFertilizer',
                        }
                    },
                    {
                        ...
                        params = {
                            args = data.entity,
                            event = 'Polar-WeedPlanting:client:AddMaleSeed',
                        }
                    }
                })
            end
...
RegisterNetEvent('Polar-WeedPlanting:client:ClearPlant', function(entity)
    ...
    QBCore.Functions.Progressbar('clear_plant', _U('clear_plant'), 8500, false, true, {
        ...
        TriggerServerEvent('Polar-WeedPlanting:server:ClearPlant', netId)
        ClearPedTasks(ped)
        RemoveAnimDict('amb@medic@standing@kneel@base')
        RemoveAnimDict('anim@gangops@facility@servers@bodysearch@')
    end, function()
...
RegisterNetEvent('Polar-WeedPlanting:client:HarvestPlant', function(entity)
    local netId = NetworkGetNetworkIdFromEntity(entity)
    local ped = PlayerPedId()
    TaskTurnPedToFaceEntity(ped, entity, 1.0)
    Wait(1500)
    ...
    QBCore.Functions.Progressbar('harvest_plant', _U('harvesting_plant'), 8500, false, true, {
        ...
        TriggerServerEvent('Polar-WeedPlanting:server:HarvestPlant', netId)
        ClearPedTasks(ped)
        RemoveAnimDict('amb@medic@standing@kneel@base')
        RemoveAnimDict('anim@gangops@facility@servers@bodysearch@')
    end, function()
...
RegisterNetEvent('Polar-WeedPlanting:client:PoliceDestroy', function(entity)
    local netId = NetworkGetNetworkIdFromEntity(entity)
    local ped = PlayerPedId()
    TaskTurnPedToFaceEntity(ped, entity, 1.0)
    Wait(500)
    ClearPedTasks(ped)
    TriggerServerEvent('Polar-WeedPlanting:server:PoliceDestroy', netId)
end)

RegisterNetEvent('Polar-WeedPlanting:client:FireGoBrrrrrrr', function(coords)
    local ped = PlayerPedId()
...
RegisterNetEvent('Polar-WeedPlanting:client:GiveWater', function(entity)
    if QBCore.Functions.HasItem(Shared.WaterItem, 1) then
        ...
        QBCore.Functions.Progressbar('weedplanting_water', _U('watering_plant'), 6000, false, false, {
            ...
            TriggerServerEvent('Polar-WeedPlanting:server:GiveWater', netId)
            ClearPedTasks(ped)
...
RegisterNetEvent('Polar-WeedPlanting:client:GiveFertilizer', function(entity)
    if QBCore.Functions.HasItem(Shared.FertilizerItem, 1) then
        ...
        QBCore.Functions.Progressbar('weedplanting_fertilizer', _U('fertilizing_plant'), 6000, false, false, {
            ...
            TriggerServerEvent('Polar-WeedPlanting:server:GiveFertilizer', netId)
            ClearPedTasks(ped)
            DeleteEntity(created_object)
        end, function()
            ClearPedTasks(ped)
...
RegisterNetEvent('Polar-WeedPlanting:client:AddMaleSeed', function(entity)
    if QBCore.Functions.HasItem(Shared.MaleSeed, 1) then
        ...
        QBCore.Functions.Progressbar('add_maleseed', _U('adding_male_seed'), 8500, false, true, {
            ...
            TriggerServerEvent('Polar-WeedPlanting:server:AddMaleSeed', netId)
            ClearPedTasks(ped)
            RemoveAnimDict('amb@medic@standing@kneel@base')
            RemoveAnimDict('anim@gangops@facility@servers@bodysearch@')
        end, function()
...
CreateThread(function()
    exports['qb-target']:AddTargetModel(Shared.WeedProps, {
        options = {
            {
                type = 'client',
                event = 'Polar-WeedPlanting:client:CheckPlant',

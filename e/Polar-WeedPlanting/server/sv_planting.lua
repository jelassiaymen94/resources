...
RegisterNetEvent('Polar-WeedPlanting:server:ClearPlant', function(netId)
...
RegisterNetEvent('Polar-WeedPlanting:server:HarvestPlant', function(netId)
    local entity = NetworkGetEntityFromNetworkId(netId)
    if not WeedPlants[entity] then return end
    local src = source
...
RegisterNetEvent('Polar-WeedPlanting:server:PoliceDestroy', function(netId)
    local entity = NetworkGetEntityFromNetworkId(netId)
    if not WeedPlants[entity] then return end
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    ...
    if DoesEntityExist(entity) then
        ...
        TriggerClientEvent('Polar-WeedPlanting:client:FireGoBrrrrrrr', -1, WeedPlants[entity].coords)
        Wait(Shared.FireTime)
        DeleteEntity(entity)
    end
end)

RegisterNetEvent('Polar-WeedPlanting:server:GiveWater', function(netId)
    local entity = NetworkGetEntityFromNetworkId(netId)
    if not WeedPlants[entity] then return end
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('Polar-WeedPlanting:server:GiveFertilizer', function(netId)
    local entity = NetworkGetEntityFromNetworkId(netId)
    if not WeedPlants[entity] then return end
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('Polar-WeedPlanting:server:AddMaleSeed', function(netId)
    local entity = NetworkGetEntityFromNetworkId(netId)
    if not WeedPlants[entity] then return end
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
RegisterNetEvent('Polar-WeedPlanting:server:CreateNewPlant', function(coords)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if not Player then return end
...
QBCore.Functions.CreateCallback('Polar-WeedPlanting:server:GetPlantData', function(source, cb, netId)
    local entity = NetworkGetEntityFromNetworkId(netId)
...
QBCore.Functions.CreateUseableItem(Shared.FemaleSeed, function(source)
    TriggerClientEvent("Polar-WeedPlanting:client:UseWeedSeed", source)
end)

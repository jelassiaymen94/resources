...
//     localStorage.setItem('inventory-color', color);
// }

// const savedColor = localStorage.getItem('inventory-color');
...
function FormatItemInfo(itemData, dom) {
    ...
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "id_card") {
            ...
            bullets = Math.round(itemData.info.ammo / mags)
            if (bullets == undefined) {bullets = 0}
            if (bullets < 1) {bullets = 'Not Even 1'}

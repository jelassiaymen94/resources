...
--- @param 600000  - Time in ms the health buff will be active
--- @param 35 - The amount of speed boost the player will recieve
    ...
    if not hasStaminaBuffActive then 
        ...
        CreateThread(function()
            ...
            while exports['ps-buffs']:HasBuff("stamina") do
                Wait(500)
                SetPlayerStamina(PlayerId(), GetPlayerStamina(PlayerId()) + math.random(10,100))
            end
...
--- @param 60000  - Time in ms the health buff will be active
--- @param 35 - The amount of swimming speed boost the player will recieve

...
### My Edit:
Reworked the CSS and JS to allow to just drop in an image for the menu in the Polar-Hud

### To Change the Logo :- 
```Head to Polar-Hud/html/Logo.png change the png here and Rename the png to Logo.png only for it to work.```
<br>
### Note- ```Capitalization matters so it should be Logo.png only!!```

_______________________________________________________________________________________________________________________________________________________________________

![Project Sloth GitHub Project Polar-Hud Banner](https://user-images.githubusercontent.com/91661118/170896135-fead50a0-2a4b-432d-8469-038acfb4f2f3.png)
...
### ⚠️Important:
- **If the minimap is pulsating or flickering, make sure if you are using custom maps that you ensure Polar-Hud BEFORE map resource.**
- **Do not rename this resource from Polar-Hud or you will encounter issues.**
...
- **This script is fully open source, it has no obfuscation.** Svelte compiled the js when it gets build and original source code is here [svelte-source](https://github.com/Project-Sloth/Polar-Hud/tree/main/svelte-source).

<br>
<br>

![Project Sloth GitHub Project Polar-Hud Install Banner](https://user-images.githubusercontent.com/91661118/170896809-5c15da71-5dd7-4f46-85c5-892701b1eea8.png)
...
### Step 1:
Go ahead and start by dragging and dropping Polar-Hud into your designated resources folder.
...
This configuration setting is found in **Polar-Hud/config.lua** as shown in the GIF below.
...
![Project Sloth GitHub Project Polar-Hud Features Banner](https://user-images.githubusercontent.com/91661118/170896822-4c6fcf43-94a3-4afd-b651-1eb76244fd8d.png)


#### Some features to mention within this Polar-Hud:
* Custom icon shapes
...
![Project Sloth GitHub Project Polar-Hud Showcase Banner](https://user-images.githubusercontent.com/91661118/170896830-39245350-47c3-4b42-93d0-ac0ca35c3711.png)


### Time to show you what it looks like!
Here's a few showcased examples while using Polar-Hud.

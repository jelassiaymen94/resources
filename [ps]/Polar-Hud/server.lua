...
local vech = GetVehiclePedIsIn(ped, false)
local class = GetVehicleType(vech)

-- if class is heli or plane then return
if class == 'heli' or class == 'plane' or class == 'submarine' or class == 'bike' then return end

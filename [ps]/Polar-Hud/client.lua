...
RegisterNetEvent('hud:client:BuffEffect', function(data)
    ...
    elseif data.display ~= nil then
        ...
        print("Polar-Hud error: data invalid from client event call: hud:client:BuffEffect")
    end
end)
...
RegisterNetEvent('hud:client:EnhancementEffect', function(data)
    ...
    elseif data.display ~= nil then
        ...
        print("Polar-Hud error: data invalid from client event call: hud:client:EnhancementEffect")
    end
end)

            ...
            if GetVehiclePedIsUsing(playerPed) ~= 0 then
                local vehicle = GetVehiclePedIsUsing(playerPed, true)
                    if vehicleWhitelist[GetVehicleClass(vehicle)] then
                        ...
                        if Config.Timer['Shooting'] == 0 and not BlacklistedWeapon(playerPed) and IsPedArmed(playerPed, 4) then
                            sleep = 10
                ...
                if Config.Timer['Shooting'] == 0  and IsPedArmed(playerPed, 4) then
                    sleep = 50

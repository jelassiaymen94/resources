...
Config.PenalCode = {
    [1] = {
        ...
        [2] = {title = 'Assault', class = 'Misdemeanor', id = 'P.C. 1002', months = 0, fine = 850, color = 'orange'},
        [3] = {title = 'Aggravated Assault', class = 'Felony', id = 'P.C. 1003', months = 10, fine = 1250, color = 'orange'},
        [4] = {title = 'Assault with a Deadly Weapon', class = 'Felony', id = 'P.C. 1004', months = 15, fine = 2000, color = 'red'},
        [5] = {title = 'Involuntary Manslaughter', class = 'Felony', id = 'P.C. 1005', months = 45, fine = 7500, color = 'red'},
        [6] = {title = 'Vehicular Manslaughter', class = 'Felony', id = 'P.C. 1006', months = 25, fine = 5500, color = 'red'},
        [7] = {title = 'Attempted Murder of a Civilian', class = 'Felony', id = 'P.C. 1007', months = 25, fine = 4000, color = 'red'},
        ...
        [10] = {title = 'First Degree Murder', class = 'Felony', id = 'P.C. 1010', months = 150, fine = 25000, color = 'red'},
        [11] = {title = 'Accessory to First Degree Murder', class = 'Felony', id = 'P.C. 1011', months = 75, fine = 15000, color = 'red'},
        [12] = {title = 'Murder of a Public Servant or Peace Officer', class = 'Felony', id = 'P.C. 1012', months = 115, fine = 15000, color = 'red'},
        [13] = {title = 'Attempted Murder of a Public Servant or Peace Officer', class = 'Felony', id = 'P.C. 1013', months = 30, fine = 8000, color = 'red'},
        [14] = {title = 'Accessory to the Murder of a Public Servant or Peace Officer', class = 'Felony', id = 'P.C. 1014', months = 60, fine = 7500, color = 'red'},
        [15] = {title = 'Unlawful Imprisonment', class = 'Misdemeanor', id = 'P.C. 1015', months = 5, fine = 900, color = 'green'},
        [16] = {title = 'Kidnapping', class = 'Felony', id = 'P.C. 1016', months = 15, fine = 1500, color = 'orange'},
        [17] = {title = 'Accessory to Kidnapping', class = 'Felony', id = 'P.C. 1017', months = 7, fine = 750, color = 'orange'},
        [18] = {title = 'Attempted Kidnapping', class = 'Felony', id = 'P.C. 1018', months = 10, fine = 850, color = 'orange'},
        [19] = {title = 'Hostage Taking', class = 'Felony', id = 'P.C. 1019', months = 14, fine = 1200, color = 'orange'},
        [20] = {title = 'Accessory to Hostage Taking', class = 'Felony', id = 'P.C. 1020', months = 8, fine = 800, color = 'orange'},
        [21] = {title = 'Unlawful Imprisonment of a Public Servant or Peace Officer.', class = 'Felony', id = 'P.C. 1021', months = 25, fine = 3000, color = 'orange'},
        ...
        [24] = {title = 'Gang Related Shooting', class = 'Felony', id = 'P.C. 1024', months = 20, fine = 2500, color = 'red'},
        [25] = {title = 'Cannibalism', class = 'Felony', id = 'P.C. 1025', months = 40, fine = 5000, color = 'red'},
        [26] = {title = 'Torture', class = 'Felony', id = 'P.C. 1026', months = 35, fine = 3500, color = 'red'},
        [27] = {title = 'Unlawful Discharge of a Firearm', class = 'Felony', id = 'P.C. 1027', months = 10, fine = 500, color = 'orange'},
    },
    [2] = {
        [1] = {title = 'Petty Theft', class = 'Infraction', id = 'P.C. 2001', months = 0, fine = 250, color = 'green'},
        [2] = {title = 'Grand Theft', class = 'Misdemeanor', id = 'P.C. 2002', months = 5, fine = 600, color = 'green'},
        [3] = {title = 'Grand Theft Auto A', class = 'Felony', id = 'P.C. 2003', months = 15, fine = 1300, color = 'green'},
        [4] = {title = 'Grand Theft Auto B', class = 'Felony', id = 'P.C. 2004', months = 25, fine = 2200, color = 'green'},
        ...
        [9] = {title = 'Attempted Robbery', class = 'Felony', id = 'P.C. 2009', months = 14, fine = 1000, color = 'green'},
        ...
        [13] = {title = 'Grand Larceny', class = 'Felony', id = 'P.C. 2013', months = 35, fine = 3500, color = 'orange'},
        [14] = {title = 'Leaving Without Paying', class = 'Infraction', id = 'P.C. 2014', months = 0, fine = 500, color = 'green'},
        [15] = {title = 'Possession of Nonlegal Currency', class = 'Misdemeanor', id = 'P.C. 2015', months = 6, fine = 750, color = 'green'},
        [16] = {title = 'Possession of Government-Issued Items', class = 'Misdemeanor', id = 'P.C. 2016', months = 15, fine = 2000, color = 'green'},
        [17] = {title = 'Possession of Items Used in the Commission of a Crime', class = 'Misdemeanor', id = 'P.C. 2017', months = 4, fine = 500, color = 'green'},
    ...
    [3] = {
        ...
        [3] = {title = 'Impersonating a Judge', class = 'Felony', id = 'P.C. 3003', months = 30, fine = 3000, color = 'green'},
        [4] = {title = 'Possession of Stolen Identification', class = 'Misdemeanor', id = 'P.C. 3004', months = 10, fine = 750, color = 'green'},
        [5] = {title = 'Possession of Stolen Government Identification', class = 'Misdemeanor', id = 'P.C. 3005', months = 12, fine = 2000, color = 'green'},
        [6] = {title = 'Extortion', class = 'Felony', id = 'P.C. 3006', months = 7, fine = 900, color = 'orange'},
        [7] = {title = 'Fraud', class = 'Misdemeanor', id = 'P.C. 3007', months = 5, fine = 450, color = 'green'},
        [8] = {title = 'Forgery', class = 'Misdemeanor', id = 'P.C. 3008', months = 8, fine = 750, color = 'green'},
        [9] = {title = 'Money Laundering', class = 'Felony', id = 'P.C. 3009', months = 30, fine = 5000, color = 'red'},
    },
    [4] = {
        [1] = {title = 'Trespassing', class = 'Misdemeanor', id = 'P.C. 4001', months = 4, fine = 450, color = 'green'},
        [2] = {title = 'Felony Trespassing', class = 'Felony', id = 'P.C. 4002', months = 8, fine = 1500, color = 'green'},
        ...
        [5] = {title = 'Vandalism of Government Property', class = 'Felony', id = 'P.C. 4005', months = 10, fine = 1500, color = 'green'},
    ...
    [5] = {
        ...
        [3] = {title = 'Possession of Contraband in a Government Facility', class = 'Felony', id = 'P.C. 5003', months = 15, fine = 1000, color = 'green'},
        [4] = {title = 'Criminal Possession of Stolen Property', class = 'Misdemeanor', id = 'P.C. 5004', months = 5, fine = 500, color = 'green'},
        [5] = {title = 'Escaping', class = 'Felony', id = 'P.C. 5005', months = 5, fine = 450, color = 'green'},
        [6] = {title = 'Jailbreak', class = 'Felony', id = 'P.C. 5006', months = 20, fine = 2500, color = 'orange'},
        [7] = {title = 'Accessory to Jailbreak', class = 'Felony', id = 'P.C. 5007', months = 10, fine = 1000, color = 'orange'},
        [8] = {title = 'Attempted Jailbreak', class = 'Felony', id = 'P.C. 5008', months = 10, fine = 1000, color = 'orange'},
        ...
        [14] = {title = 'Conspiracy', class = 'Misdemeanor', id = 'P.C. 5014', months = 5, fine = 450, color = 'green'},
        [15] = {title = 'Violating a Court Order', class = 'Misdemeanor', id = 'P.C. 5015', months = 0, fine = 10000, color = 'orange'},
        [16] = {title = 'Failure to Appear', class = 'Misdemeanor', id = 'P.C. 5016', months = 0, fine = 1000, color = 'orange'},
    ...
    [6] = {
        ...
        [4] = {title = 'False Reporting', class = 'Misdemeanor', id = 'P.C. 6004', months = 5, fine = 750, color = 'green'},
        [5] = {title = 'Harassment', class = 'Misdemeanor', id = 'P.C. 6005', months = 5, fine = 500, color = 'orange'},
        [6] = {title = 'Misdemeanor Obstruction of Justice', class = 'Misdemeanor', id = 'P.C. 6006', months = 4, fine = 500, color = 'green'},
        [7] = {title = 'Felony Obstruction of Justice', class = 'Felony', id = 'P.C. 6007', months = 8, fine = 900, color = 'green'},
        [8] = {title = 'Inciting a Riot', class = 'Felony', id = 'P.C. 6008', months = 20, fine = 1500, color = 'orange'},
        [9] = {title = 'Loitering on Government Properties', class = 'Infraction', id = 'P.C. 6009', months = 0, fine = 500, color = 'green'},
        [10] = {title = 'Tampering', class = 'Misdemeanor', id = 'P.C. 6010', months = 6, fine = 500, color = 'green'},
        [11] = {title = 'Vehicle Tampering', class = 'Misdemeanor', id = 'P.C. 6011', months = 9, fine = 750, color = 'green'},
        [12] = {title = 'Evidence Tampering', class = 'Felony', id = 'P.C. 6012', months = 12, fine = 1000, color = 'green'},
        [13] = {title = 'Witness Tampering', class = 'Felony', id = 'P.C. 6013', months = 20, fine = 2000, color = 'green'},
        [14] = {title = 'Failure to Provide Identification', class = 'Misdemeanor', id = 'P.C. 6014', months = 7, fine = 1000, color = 'green'},
        ...
        [17] = {title = 'Government Corruption', class = 'Felony', id = 'P.C. 6017', months = 50, fine = 15000, color = 'red'},
        [18] = {title = 'Stalking', class = 'Felony', id = 'P.C. 6018', months = 20, fine = 1500, color = 'orange'},
        [19] = {title = 'Aiding and Abetting', class = 'Misdemeanor', id = 'P.C. 6019', months = 7, fine = 450, color = 'orange'},
    ...
    [7] = {
        ...
        [13] = {title = 'Felony Possession of Oxy / Vicodin', class = 'Felony', id = 'P.C. 7013', months = 20, fine = 1500, color = 'green'},
        [14] = {title = 'Felony Possession of Oxy / Vicodin with Intent to Distribute', class = 'Felony', id = 'P.C. 7014', months = 30, fine = 4000, color = 'orange'},
        ...
        [19] = {title = 'Felony Possession of Opium', class = 'Felony', id = 'P.C. 7019', months = 20, fine = 1500, color = 'green'},
        ...
        [34] = {title = 'Drug Trafficking', class = 'Felony', id = 'P.C. 7034', months = 45, fine = 8000, color = 'red'},
        ...
        [37] = {title = 'Public Indecency', class = 'Misdemeanor', id = 'P.C. 7037', months = 6, fine = 750, color = 'green'},
    },
    [8] = {
        [1] = {title = 'Criminal Possession of Weapon Class 1', class = 'Felony', id = 'P.C. 8001', months = 10, fine = 500, color = 'green'},
        [2] = {title = 'Criminal Possession of Weapon Class 2', class = 'Felony', id = 'P.C. 8002', months = 15, fine = 1500, color = 'green'},
        [3] = {title = 'Criminal Possession of Weapon Class 3', class = 'Felony', id = 'P.C. 8003', months = 30, fine = 3500, color = 'green'},
        [4] = {title = 'Criminal Possession of Weapon Class D', class = 'Felony', id = 'P.C. 8004', months = 25, fine = 2500, color = 'green'},
        [5] = {title = 'Criminal Sale of Weapon Class 1', class = 'Felony', id = 'P.C. 8005', months = 15, fine = 1000, color = 'orange'},
        [6] = {title = 'Criminal Sale of Weapon Class 2', class = 'Felony', id = 'P.C. 8006', months = 20, fine = 2000, color = 'orange'},
        [7] = {title = 'Criminal Sale of Weapon Class 3', class = 'Felony', id = 'P.C. 8007', months = 35, fine = 7000, color = 'orange'},
        [8] = {title = 'Criminal Sale of Weapon Class D', class = 'Felony', id = 'P.C. 8008', months = 30, fine = 3000, color = 'orange'},
        [9] = {title = 'Criminal Use of Weapon', class = 'Misdemeanor', id = 'P.C. 8009', months = 5, fine = 450, color = 'orange'},
        [10] = {title = 'Possession of Illegal Firearm Modifications', class = 'Misdemeanor', id = 'P.C. 8010', months = 5, fine = 300, color = 'green'},
        [11] = {title = 'Weapon Trafficking', class = 'Felony', id = 'P.C. 8011', months = 45, fine = 8000, color = 'red'},
        [12] = {title = 'Brandishing a Weapon', class = 'Misdemeanor', id = 'P.C. 8012', months = 5, fine = 500, color = 'orange'},
        [13] = {title = 'Insurrection', class = 'Felony', id = 'P.C. 8013', months = 0, fine = 0, color = 'red'},
        [14] = {title = 'Flying into Restricted Airspace', class = 'Felony', id = 'P.C. 8014', months = 10, fine = 1500, color = 'green'},
    ...
    [9] = {
        ...
        [19] = {title = 'Hit and Run', class = 'Misdemeanor', id = 'P.C. 9019', months = 7, fine = 500, color = 'green'},
        ...
        [22] = {title = 'Piloting without Proper Licensing', class = 'Felony', id = 'P.C. 9022', months = 12, fine = 1500, color = 'orange'},
    ...
    [10] = {
        ...
        [3] = {title = 'Animal Cruelty', class = 'Misdemeanor', id = 'P.C. 10003', months = 8, fine = 450, color = 'green'},
        [4] = {title = 'Hunting with a Non-Hunting Weapon', class = 'Misdemeanor', id = 'P.C. 10004', months = 7, fine = 750, color = 'green'},
        ...
        [7] = {title = 'Poaching', class = 'Felony', id = 'P.C. 10007', months = 15, fine = 1250, color = 'red'},
    }
}

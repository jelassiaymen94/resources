...
dispatchCodes = {
	...
	["speeding"] =  {displayCode = '10-12', description = " Speeding In Progress ", radius = 0, recipientList = {'police'}, blipSprite = 326, blipColour = 84, blipScale = 1.5, blipLength = 2, sound = "Lose_1st", sound2 = "GTAO_FM_Events_Soundset", offset = "false", blipflash = "false"},
	...
	["911call"] =  {displayCode = '911', description = "911 Call", radius = 0, recipientList = {'police', 'ambulance', 'weazelnews',}, blipSprite = 480, blipColour = 1, blipScale = 1.5, blipLength = 2, sound = "Lose_1st", sound2 = "GTAO_FM_Events_Soundset", offset = "false", blipflash = "false"},
	["311call"] =  {displayCode = '911', description = "311 Call", radius = 0, recipientList = {'police', 'ambulance', 'weazelnews',}, blipSprite = 480, blipColour = 3, blipScale = 1.5, blipLength = 2, sound = "Lose_1st", sound2 = "GTAO_FM_Events_Soundset", offset = "false", blipflash = "false"},
    ...
    ["banktruckrobbery"] =  {displayCode = '10-90', description = "Bank Truck Robbery In Progress", radius = 0, recipientList = {'police'}, blipSprite = 477, blipColour = 2, blipScale = 1.5, blipLength = 2, sound = "robberysound", offset = "false", blipflash = "false"},
	["scraprobbery"] =  {displayCode = '10-90', description = "Scrap Heist In Progress", radius = 0, recipientList = {'police'}, blipSprite = 318, blipColour = 2, blipScale = 1.5, blipLength = 2, sound = "robberysound", offset = "false", blipflash = "false"},
	-- Rainmad Heists

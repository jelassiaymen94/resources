...
-----------------------------------------------------------------------------------------------------------
   ...
   --["sunbathe3"] = {"Scenario", "WORLD_HUMAN_SUNBATHE", "Sunbathe 3"}, CAN GLITCH THROUGH WALLS
...
DP.PropEmotes = {
	...
	{	Prop = 'hane_bakery_cupcake1', PropBone = 18905, PropPlacement = {0.13, 0.06, 0.02, -120.0, 0.0, 0.0},
		EmoteLoop = true, EmoteMoving = true, }},
	["cupcake2"] = {"mp_player_inteat@burger", "mp_player_int_eat_burger", "Cup Cake 2", AnimationOptions =
	{	Prop = 'hane_bakery_cupcake2', PropBone = 18905, PropPlacement = {0.13, 0.06, 0.02, -120.0, 0.0, 0.0},
		EmoteLoop = true, EmoteMoving = true, }},
		
	--Cake Eating
	["cake1"] = {"mp_player_inteat@burger", "mp_player_int_eat_burger", "Cake 1", AnimationOptions =
	{	Prop = 'hane_bakery_cake1', PropBone = 18905, PropPlacement = {0.13, 0.1, -0.06, -80.0, 0.0, -20.0},
		EmoteLoop = true, EmoteMoving = true, }},
	["cake2"] = {"mp_player_inteat@burger", "mp_player_int_eat_burger", "Cake 2", AnimationOptions =
	{	Prop = 'hane_bakery_cake2', PropBone = 18905, PropPlacement = {0.13, 0.1, -0.06, -80.0, 50.0, -20.0},
		EmoteLoop = true, EmoteMoving = true, }},
	["cake3"] = {"mp_player_inteat@burger", "mp_player_int_eat_burger", "Cake 3", AnimationOptions =
	{	Prop = 'hane_bakery_cake3', PropBone = 18905, PropPlacement = {0.10, 0.03, 0.05, -30.0, -30.0, 0.0},
		EmoteLoop = true, EmoteMoving = true, }},
    ["megaphone"] = {"amb@world_human_mobile_film_shocking@female@base", "base", "Megaphone", AnimationOptions =
    {
            Prop = 'prop_megaphone_01',
	...
	{	Prop = 'hane_bakery_cake1', PropBone = 24817, PropPlacement = {-0.04, 0.46, -0.016, -160.0, -90.0, 0.0},
		EmoteMoving = true,	EmoteLoop = true }},	
	["cakehold2"] = {"impexp_int-0", "mp_m_waremech_01_dual-0", "Cake Hold 2", AnimationOptions =
	{	Prop = 'hane_bakery_cake2', PropBone = 24817, PropPlacement = {-0.04, 0.46, -0.016, -160.0, -90.0, 0.0},
		EmoteMoving = true,	EmoteLoop = true }},
	["cakehold3"] = {"impexp_int-0", "mp_m_waremech_01_dual-0", "Cake Hold 3", AnimationOptions =
	{	Prop = 'hane_bakery_cake3', PropBone = 24817, PropPlacement = {-0.11, 0.46, -0.016, -210.0, -90.0, 0.0},
		EmoteMoving = true,	EmoteLoop = true }},
	
	--Bread Holding
	["breadhold1"] = {"impexp_int-0", "mp_m_waremech_01_dual-0", "Bread Hold 2", AnimationOptions =
	{	Prop = 'hane_bread_1', PropBone = 24817, PropPlacement = {-0.10, 0.46, -0.016, -210.0, -90.0, 0.0},
		EmoteMoving = true,	EmoteLoop = true }},
	["breadhold2"] = {"impexp_int-0", "mp_m_waremech_01_dual-0", "Bread Hold 2", AnimationOptions =
	{	Prop = 'hane_bread_2', PropBone = 24817, PropPlacement = {-0.10, 0.46, -0.016, -210.0, -90.0, 0.0},
		EmoteMoving = true,	EmoteLoop = true }},
	["breadhold3"] = {"impexp_int-0", "mp_m_waremech_01_dual-0", "Bread Hold 2", AnimationOptions =
	{	Prop = 'hane_bread_3', PropBone = 24817, PropPlacement = {-0.10, 0.46, -0.016, -210.0, -90.0, 0.0},
		EmoteMoving = true,	EmoteLoop = true }},
	["breadhold4"] = {"impexp_int-0", "mp_m_waremech_01_dual-0", "Bread Hold 2", AnimationOptions =
	{	Prop = 'hane_bread_4', PropBone = 24817, PropPlacement = {-0.10, 0.46, -0.016, -210.0, -90.0, 0.0},
		EmoteMoving = true,	EmoteLoop = true }},
	--Bread Roll
	["breadroll1"] = {"mp_player_inteat@burger", "mp_player_int_eat_burger", "Bread Roll 1", AnimationOptions =
	{	Prop = 'hane_bread_roll_1', PropBone = 18905, PropPlacement = {0.13, 0.06, 0.02, 20.0, 120.0, 0.0},
		EmoteLoop = true, EmoteMoving = true, }},
	["breadroll2"] = {"mp_player_inteat@burger", "mp_player_int_eat_burger", "Bread Roll 2", AnimationOptions =
	{	Prop = 'hane_bread_roll_2', PropBone = 18905, PropPlacement = {0.13, 0.06, 0.02, 20.0, 120.0, 0.0},
		EmoteLoop = true, EmoteMoving = true, }},
	["breadroll3"] = {"mp_player_inteat@burger", "mp_player_int_eat_burger", "Bread Roll 3", AnimationOptions =
	{	Prop = 'hane_bread_roll_3', PropBone = 18905, PropPlacement = {0.13, 0.06, 0.02, 20.0, 120.0, 0.0},
		EmoteLoop = true, EmoteMoving = true, }},
	["breadroll4"] = {"mp_player_inteat@burger", "mp_player_int_eat_burger", "Bread Roll 4", AnimationOptions =
	{	Prop = 'hane_bread_roll_4', PropBone = 18905, PropPlacement = {0.13, 0.06, 0.02, 20.0, 120.0, 0.0},
		EmoteLoop = true, EmoteMoving = true, }},
	...
	{	Prop = 'hane_pastry_1', PropBone = 18905, PropPlacement = {0.13, 0.06, 0.02, 20.0, 120.0, 0.0},
		EmoteLoop = true, EmoteMoving = true, }},
	["choccroiss"] = {"mp_player_inteat@burger", "mp_player_int_eat_burger", "Croissant Sauce", AnimationOptions =
	{	Prop = 'hane_pastry_2', PropBone = 18905, PropPlacement = {0.13, 0.06, 0.02, 20.0, 120.0, 0.0},
		EmoteLoop = true, EmoteMoving = true, }},
	["sweetroll"] = {"mp_player_inteat@burger", "mp_player_int_eat_burger", "Sweet Roll", AnimationOptions =
	{	Prop = 'hane_pastry_3', PropBone = 18905, PropPlacement = {0.13, 0.06, 0.02, 20.0, 120.0, 0.0},
		EmoteLoop = true, EmoteMoving = true, }},
	["cookie"] = {"mp_player_inteat@burger", "mp_player_int_eat_burger", "Cookie", AnimationOptions =
	{	Prop = 'hane_pastry_4', PropBone = 18905, PropPlacement = {0.15, 0.08, 0.02, 20.0, 140.0, 0.0},
		EmoteLoop = true, EmoteMoving = true, }},

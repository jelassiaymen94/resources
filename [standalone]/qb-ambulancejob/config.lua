...
Config.BleedMovementTick = 7 -- How many seconds is taken away from the bleed tick rate if the player is walking, jogging, or sprinting
...
Config.AdvanceBleedTimer = 20 -- How many bleed ticks occur before bleed level increases
...
Config.LegInjuryTimer = 60 -- How much time, in seconds, do leg injury effects chance occur
...
["checking"] = {
    [1] = vector3(307.57, -595.28, 43.12), -- pillbox
    [2] = vector3(-817.39, -1236.78, 7.34), -- viceroy
},
["duty"] = {
    [1] = vector3(311.63, -594.13, 43.28), --pillbox
    [2] = vector3(-813.96, -1236.64, 7.34), -- viceroy
},
["vehicle"] = {
   -- [1] = vector4(294.578, -574.761, 43.179, 35.79), --pillbox
   -- [2] = vector4(-842.55, -1229.48, 6.93, 10.53), -- viceroy
},
["helicopter"] = {
    --[1] = vector4(351.58, -587.45, 74.16, 160.5), --pillbox
    --[2] = vector4(-791.1, -1191.3, 53.03, 322.55), -- viceroy
},
["armory"] = {
    [1] = vector3(303.81, -600.39, 43.28), --pillbox
    [2] = vector3(-822.51, -1240.89, 7.34), --viceroy
},
["roof"] = {
    --[1] = vector4(338.5, -583.85, 74.16, 245.5), --pillbox
    --[2] = vector4(-773.97, -1207.46, 51.15, 320.34), -- viceroy
},
["main"] = {
    --[1] = vector3(327.1, -603.8, 43.28), -- pillbox
    --[2] = vector3(-801.54, -1251.81, 7.34), -- viceroy
},
["stash"] = {
    [1] = vector3(306.83, -601.84, 43.28), -- pillbox
    [2] = vector3(-820.02, -1242.99, 7.34), -- viceroy
},
["beds"] = {
    [1] = {coords = vector4(314.57, -584.15, 44.2, 335.53), taken = false, model = 1631638868},
    [2] = {coords = vector4(317.84, -585.15, 44.2, 337.33), taken = false, model = 1631638868},
    [3] = {coords = vector4(322.7, -587.09, 44.2, 341.23), taken = false, model = 1631638868},
    [4] = {coords = vector4(324.21, -582.81, 44.2, 155.44), taken = false, model = 1631638868},
    [5] = {coords = vector4(319.22, -581.13, 44.2, 163.97), taken = false, model = 1631638868},
    [6] = {coords = vector4(313.83, -578.99, 44.2, 154.84), taken = false, model = 1631638868},
    [7] = {coords = vector4(309.17, -577.48, 44.2, 157.17), taken = false, model = 1631638868},
    --[8] = {coords = vector4(307.84, -581.63, 44.2, 327.06), taken = false, model = 1631638868},
--- paleto
    [8] = {coords = vector4(-252.43, 6312.25, 32.34, 313.48), taken = false, model = 2117668672},
    [9] = {coords = vector4(-247.04, 6317.95, 32.34, 134.64), taken = false, model = 2117668672},
    [10] = {coords = vector4(-255.98, 6315.67, 32.34, 313.91), taken = false, model = 2117668672},
},
["jailbeds"] = {
...
Config.StaggerAreas = { -- Define body areas that will always cause staggering if wearing armor or not
    ['SPINE'] = { armored = false, major = 40, minor = 40 },
    ['UPPER_BODY'] = { armored = false, major = 40, minor = 40 },
    ['LLEG'] = { armored = false, major = 40, minor = 40 },
    ['RLEG'] = { armored = false, major = 40, minor = 40 },
    ['LFOOT'] = { armored = false, major = 40, minor = 40 },
    ['RFOOT'] = { armored = false, major = 40, minor = 40 },
}

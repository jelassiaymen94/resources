...
Config.FleecaGoldMax = 1 -- Maximum gold bars from Fleecas
...
Config.PaletoGoldMax = 1 -- Maximum gold bars from Paleto
...
---- ** PACIFIC LOOT TABLES ** ----
Config.PacificBagsMin = 3 -- How many bags of Marked Bills can you MINIMUM get from a pacific Table?
Config.PacificBagsMax = 4 -- How many bags of Marked Bills can you MAXIMUM get from a pacific Table?
Config.PacificGoldMin = 3 -- Minimum gold bars from pacific
Config.PacificGoldMax = 5 -- Maximum gold bars from pacific

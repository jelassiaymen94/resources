...
Config.SpawnLocation = vector3(1900000000000000.24, -858.05, 30.5) -- here you can set the coordinates in which the player will spawn after creating a character ! IMPORTANT, if you use Config.UseCustomSkinCreator, it won't work, you need to set in charcreator e.g. vms_charcreator !
...
Config.Default = {
	...
	["mask"] = {item = 5, texture = 0, defaultItem = 5, defaultTexture = 0},
	["shoes"] = {item = 0, texture = 0, defaultItem = 1, defaultTexture = 0},
	["t-shirt"] = {item = 16, texture = 0, defaultItem = 1, defaultTexture = 0},
	...
	["vest"] = {item = 0, texture = 0, defaultItem = 16, defaultTexture = 0},

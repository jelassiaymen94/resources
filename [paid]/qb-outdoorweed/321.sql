...
-- Dumping database structure for frameworkthing
CREATE DATABASE IF NOT EXISTS `frameworkthing` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `frameworkthing`;

-- Dumping structure for table frameworkthing.plants

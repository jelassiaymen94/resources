...
Config.GemsBuyingPedLoc = vector4(-1816.64, -1193.78, -130.3, 334.81) -- Gems Buying Ped Location
...
Config.MinFisherMan = 4 -- Min fishermen in the tournament for a torunament to start
Config.ChanceToLozeKey = 5 -- % chance the key will be taken when the player fails to open the chest
...
Config.MiniGame1Speed = 2 -- speed at which the minigame goes at. examples you would want to try are 0.001, 0.002, 0.003, etc.
Config.TournamentZoneBlip = 316 -- Tournament Zone Blip Sprite
Config.TournamentZoneBlipColor = 31 -- Tournament Zone Blip color
Config.FirstPlacePayout = 2500 -- this is the payout times the amount of people in the tournament
Config.SecondPlacePayout = 2000 -- this is the payout times the amount of people in the tournament
Config.ThirdPlacePayout = 1500 -- this is the payout times the amount of people in the tournament
Config.UseDefaultPed = true -- Shouldnt change this if you follow readme properly

--Beginner Fishing Rod
Config.Rod1AttemptsMin = 1 -- minimum ammout of times you need to do the skillcheck 
Config.Rod1AttemptsMax = 4 -- maximum ammout of times you need to do the skillcheck 
...
Config.AllUsesPsUiLock = true-- make this true if you only want to use Polar-Minigames lock for all fishing rod minigames
--
-- First Fishing Rod (All Polar-Minigames Lock)
...
-- Second Fishing Rod (All Polar-Minigames Lock)
...
-- Third Fishing Rod (All Polar-Minigames Lock)
...
Config.ProfessionalRodGame = 'qb-lock' -- only change this if you have changed your qb-lock file name or if you are using Polar-Minigames. Not just any minigame will work
...
Config.SecondsMin = 30 -- minimum ammout of time the skill check can go on for
Config.SecondsMax = 30 -- maximum ammout of time the skill check can go on for
...
Config.SellFishies = {
    ...
    ["stripedbass"] = {
        price = math.random(110,135)
    },
    ["bluefish"] = {
        price = math.random(125,150)
    },
    ["redfish"] = {
        price= math.random(140,175) 
    },
    ["goldfish"] = {
        price = math.random(160,185)
    },
    ["largemouthbass"] = {
        price = math.random(190,220)
    },
    ["swordfish"] = {
        price = math.random(210,250)
    },
    ["salmon"] = {
        price = math.random(230,275)
    },
    ["catfish"] = {
        price = math.random(260,285)
    },
    ["rainbowtrout"] = {
        price = math.random(275,310)
    },
    ["tigershark"] = {
        price = math.random(330,360)
    },
    ["stingraymeat"] = {
        price = math.random(400,420)
    },
    ["tuna-fish"] = {
        price = math.random(505,520)
    },
    ["killerwhale"] = {
        price = math.random(630,650)
    },
}
...
Config.TreasureLocations =  {
   ...
   --[[ [1] = vector3(-2167.7793, 3085.9172, 32.8101),
    [2] = vector3(-2160.4714, 3080.8723, 32.8101),
    [3] = vector3(-2152.3547, 3076.3469, 32.8101),
    ...
    [13] = vector3(-198.96, 3604.64, 52.26),[14] = vector3(-56.58, 3096.97, 26.74),

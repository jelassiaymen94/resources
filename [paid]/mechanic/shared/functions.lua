...
function useMechJob() if GetResourceState('qb-mechanicjob') == "started" then return true else return false end
end
...
function updateCar(vehicle)
	...
	if Config.Debug then print("^5Debug^7: ^2Updating database timer started/reset^7: '^6" ..vehicle.."^7' - ^4"..(updateDelay[vehicle] * 10).." ^2Seconds^7.") end
end

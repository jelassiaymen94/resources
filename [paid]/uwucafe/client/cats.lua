...
CreateThread(function()
	for k, v in pairs(PedList) do
		Cats[#Cats+1] = makePed(`a_c_cat_01`, vector4(v.coords.x, v.coords.y, v.coords.z+0.03, v.coords.w), 0, nil, nil, nil)
		Targets["CatPat"..k] =
		...
		if v.frozen then
			...
			CreateThread(function()
				local cat = cat
				local routeCoords = {
					vector4(-573.59, -1051.73, 22.34, 312.5),
					vector4(-576.5, -1053.52, 22.34, 123.7),
					vector4(-579.85, -1057.09, 22.34, 194.87),
					vector4(-581.38, -1053.72, 22.35, 38.59),
					vector4(-582.61, -1051.24, 22.34, 46.58),
					vector4(-585.93, -1053.67, 22.35, 107.41),
					vector4(-585.93, -1053.67, 22.35, 107.41),
					vector4(-585.93, -1053.67, 22.35, 107.41),
					vector4(-576.48, -1064.01, 22.34, 175.03),
					vector4(-578.47, -1067.17, 22.34, 119.52),
					vector4(-582.69, -1067.03, 22.34, 81.25),
					vector4(-582.69, -1067.03, 22.34, 81.25),
					vector4(-582.4, -1062.29, 22.35, 343.69),
					vector4(-580.1, -1058.88, 22.34, 295.82)
				}
...
PedList = {
	...
	{ coords = vector4(-577.14, -1069.22, 22.99, 0), animDict = "creatures@cat@amb@world_cat_sleeping_ground@base", animName = "base", clickable = true, frozen = true },
	{ coords = vector4(-586.85, -1064.68, 23.35, 0), animDict = "creatures@cat@amb@world_cat_sleeping_ground@base", animName = "base", clickable = true, frozen = true },
	{ coords = vector4(-576.49, -1054.94, 22.42, 350.0), animDict = "creatures@cat@amb@world_cat_sleeping_ground@base", animName = "base", clickable = true, frozen = true },
	{ coords = vector4(-582.07, -1055.92, 22.43, 250.0), animDict = "creatures@cat@amb@world_cat_sleeping_ground@base", animName = "base", clickable = true, frozen = true },
	{ coords = vector4(-583.32, -1069.32, 22.99, 90.0), animDict = "creatures@cat@amb@world_cat_sleeping_ground@base", animName = "base", clickable = true, frozen = true },
	{ coords = vector4(-584.33, -1062.76, 23.40, 223.0), animDict = "creatures@cat@amb@world_cat_sleeping_ground@base", animName = "base", clickable = true, frozen = true, },
	{ coords = vector4(-575.53, -1049.41, 23.53, 90.0), animDict = "creatures@cat@amb@world_cat_sleeping_ground@base", animName = "base", clickable = true, frozen = true, },
	{ coords = vector4(-584.71, -1054.55, 23.33, 280.0), animDict = "creatures@cat@amb@world_cat_sleeping_ground@base", animName = "base", clickable = true, frozen = true },

	{ coords = vector4(-576.78, -1057.52, 25.15, 0.0), animDict = "creatures@cat@amb@world_cat_sleeping_ledge@base", animName = "base", clickable = false, frozen = true },
	{ coords = vector4(-583.55, -1048.88, 25.50, 240.0), animDict = "creatures@cat@amb@world_cat_sleeping_ledge@base", animName = "base", clickable = false, frozen = true },
	{ coords = vector4(-595.29, -1055.54, 22.43, 180.0), animDict = "creatures@cat@amb@world_cat_sleeping_ledge@base", animName = "base", clickable = false, frozen = true },
	{ coords = vector4(-587.4, -1059.6, 23.3, 180.0), animDict = "creatures@cat@amb@world_cat_sleeping_ledge@base", animName = "base", clickable = false, frozen = true },
	{ coords = vector4(-571.65, -1057.26, 22.54, 90.0), animDict = "creatures@cat@move", animName = "gallop", clickable = false, frozen = true },

	{ coords = vector4(-573.78, -1052.5, 22.34, 90.0), frozen = false },
	{ coords = vector4(-582.57, -1059.72, 22.34, 180.0), frozen = false },
	{ coords = vector4(-582.35, -1050.91, 22.34, 180.0), frozen = false },
	{ coords = vector4(-585.55, -1067.99, 22.34, 0.0), frozen = false },

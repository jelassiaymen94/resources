...
function Radio:connecttoradio(channel)
    ...
    TriggerServerEvent('radio:server:addToRadioChannel', self.RadioChannel)
...
function Radio:leaveradio()
    self:closeEvent()
    TriggerServerEvent('radio:server:removeFromRadioChannel', self.RadioChannel)
    self.RadioChannel = 0
    self.onRadio = false
    exports["pma-voice"]:setRadioChannel(0)

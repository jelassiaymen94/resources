...
RegisterNetEvent('radio:client:use', function()
...
RegisterNetEvent('radio:client:remove', function()
...
RegisterNetEvent('radio:client:radioListUpdate', function(players, channel)

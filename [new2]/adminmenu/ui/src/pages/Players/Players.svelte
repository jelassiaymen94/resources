						...
						on:click={() =>
							SendNUI("clickButton", {
								data: {
									...
									event: `adminmenu:server:TeleportToPlayer`,
									type: 'server',
									perms: "mod"
								},
								selectedData: {
					...
					<button title="Bring Player"
						...
						on:click={() =>
							SendNUI("clickButton", {
								data: {
									label: "Bring Player",
									event: `adminmenu:server:BringPlayer`,
									type: 'server',
									perms: "mod"
								},
								selectedData: {
						...
						on:click={() =>
							SendNUI("clickButton", {
								data: {
									...
									event: `adminmenu:server:SpectateTarget`,
									type: 'server',
									perms: "mod"
								},
								selectedData: {
								...
								on:click={() =>
									SendNUI("clickButton", {
										data: {
											...
											event: `adminmenu:client:SpawnPersonalvehicle`,
											type: 'client',
											perms: "mod"
										},
										selectedData: {
		...
		<button
			...
			on:click={() => {
				...
				SendNUI("clickButton", {
					data: {
						label: "Ban Player",
						event: `adminmenu:server:BanPlayer`,
						type: 'server',
						perms: "mod"
					},
					selectedData: {
		...
		<button
			...
			on:click={() => {
				SendNUI("clickButton", {
					data: {
						label: "Kick Player",
						event: `adminmenu:server:KickPlayer`,
						type: 'server',
						perms: "mod"
					},
					selectedData: {

	...
	const debugActions = [
		...
		},
		{
			...
			dropdown: [
				...
				{ label: "Ban", type: "server", option: "button", event: "adminmenu:client:banplayer" },
			],
		},
		{
			id: "noclip",
		...
		},
		{
			...
			type: "client",
			perms: "mod",
			event: "adminmenu:client:invisible",
		},
		{
			id: "kick_player",
			label: "Kick Player",
			type: "client",
			perms: "mod",
			event: "adminmenu:client:kickplayer",
			dropdown: [
				{ label: "Player", option: "dropdown", data: "players" },
				{ label: "Reason", option: "text" },
				{ label: "Time", option: "dropdown", 

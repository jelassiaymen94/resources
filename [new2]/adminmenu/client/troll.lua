-- Set on fire
RegisterNetEvent('adminmenu:client:SetOnFire', function(time)
...
-- Explode player
RegisterNetEvent('adminmenu:client:ExplodePlayer', function(damage)
...
-- Play Sound
RegisterNetEvent('adminmenu:client:PlaySound', function(data, selectedData)

...
RegisterNetEvent('adminmenu:requestSpectate', function(targetPed, target, name)
...
RegisterNetEvent('adminmenu:cancelSpectate', function()
    ...
    while true do
        ...
        if spectateInfo['toggled'] then
            ...
            if DoesEntityExist(targetPed) then
                ...
                TriggerServerEvent('adminmenu:spectate:teleport', spectateInfo['target'])

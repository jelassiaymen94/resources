-- Admin Car
RegisterNetEvent('adminmenu:server:SaveCar', function(mods, vehicle, _, plate)
    local src = source
...
-- Change Plate
RegisterNetEvent('adminmenu:server:ChangePlate', function(newPlate, currentPlate)
...
lib.callback.register('adminmenu:server:GetVehicleByPlate', function(source, plate)
...
RegisterNetEvent('adminmenu:server:FixVehFor', function(data, selectedData)

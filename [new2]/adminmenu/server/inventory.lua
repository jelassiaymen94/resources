-- Clear Inventory
RegisterNetEvent('adminmenu:server:ClearInventory', function(data, selectedData)
...
-- Open Inv [ox side]
RegisterNetEvent('adminmenu:server:OpenInv', function(data)
    exports.ox_inventory:forceOpenInventory(source, 'player', data)
end)

-- Open Stash [ox side]
RegisterNetEvent('adminmenu:server:OpenStash', function(data)
    exports.ox_inventory:forceOpenInventory(source, 'stash', data)
end)

-- Give Item
RegisterNetEvent('adminmenu:server:GiveItem', function(data, selectedData)
    if not CheckPerms(data.perms) then return end
...
-- Give Item to All
RegisterNetEvent('adminmenu:server:GiveItemAll', function(data, selectedData)
    if not CheckPerms(data.perms) then return end

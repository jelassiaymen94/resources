    ...
    zone:onPlayerInOut(function (isPointInside)
        if isPointInside then
            ...
            pp = exports['qb-radialmenu']:AddOption( {
                ...
                icon = 'bolt',
                type = 'client',
                event = 'Polar-Houses:client:houseleave',
                shouldClose = true
            }, pp)
        else
...
RegisterNetEvent('Polar-Houses:client:houseleave', function()
    ...
    zone:onPlayerInOut(function (isPointInside)
        if isPointInside then
            ...
            pp = exports['qb-radialmenu']:AddOption( {
                ...
                icon = 'bolt',
                type = 'client',
                event = 'Polar-Houses:client:openhouse',
                shouldClose = true
            }, pp)
        else
            --CloseMenuFull()
...
RegisterNetEvent('Polar-Houses:client:openhouse', function()

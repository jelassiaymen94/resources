...
Config.ClothingRooms = {
    [1] = {requiredJob = 'police', isGang = false, coords = vector3(461.16, -996.54, 30.69), width = 5, length = 5, cameraLocation = vector4(458.18, -998.27, 30.69, 308.85)}, -- mrpd
    [2] = {requiredJob = 'ambulance', isGang = false, coords = vector3(298.6, -598.14, 43.28), width = 5, length = 5, cameraLocation = vector4(301.86, -596.88, 43.28, 105.24)}, -- phillbox
    [3] = {requiredJob = 'tuner', isGang = false, coords = vector3(124.53, -3010.7, 7.04), width = 5, length = 5, cameraLocation = vector4(127.67, -3010.88, 7.04, 83.44)},
    [4] = {requiredJob = 'police', isGang = false, coords = vector3(362.07, -1591.0, 25.45), width = 2, length = 2, cameraLocation = vector4(362.37, -1594.15, 25.45, 359.79)},
            ...
            [4] = {
                -- Grade Level
                    ...
                    [1] = {
                        outfitLabel = 'Police Day 1',
                        outfitData = {
                            ['pants'] = {item = 174, texture = 0}, -- Pants
                            ['arms'] = {item = 11, texture = 0}, -- Arms
                            ['t-shirt'] = {item = 160, texture = 0}, -- T Shirt
                            ['vest'] = {item = 12, texture = 0}, -- Body Vest
                            ['torso2'] = {item = 302, texture = 21}, -- Jacket
                            ['shoes'] = {item = 64, texture = 0}, -- Shoes
        ...
        ['male'] = {
            ...
            [0] = {
                ...
                [1] = {
                    outfitLabel = 'T-Shirt',
                    outfitData = {
                        ['arms'] = {item = 129, texture = 0}, -- Arms
                        ['t-shirt'] = {item = 208, texture = 0}, -- T-Shirt
                        ['torso2'] = {item = 351 , texture = 14}, -- Jackets
                        ['vest'] = {item = 0, texture = 0}, -- Vest
                        ['decals'] = {item = 0, texture = 0}, -- Decals
                        ['accessory'] = {item = 176, texture = 0}, -- Neck
                        ['bag'] = {item = 0, texture = 0}, -- Bag
                        ['pants'] = {item = 95, texture = 0}, -- Pants
                        ['shoes'] = {item = 65, texture = 0}, -- Shoes
                        ['mask'] = {item = 121, texture = 0}, -- Mask
                        ['hat'] = {item = 138, texture = 0}, -- Hat
                        ['glass'] = {item = 0, texture = 0}, -- Glasses

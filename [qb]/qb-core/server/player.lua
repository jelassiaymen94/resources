...
function QBCore.Player.CheckPlayerData(source, PlayerData)
    ...
    PlayerData.metadata['methrunclass'] = PlayerData.metadata['methrunclass'] or 'D'
    PlayerData.metadata['methrunclass'] = PlayerData.metadata['methrunclass'] or 0
    ...
    PlayerData.metadata['truckerxp'] = PlayerData.metadata['truckerxp'] or 0
    PlayerData.metadata['houserobberyxp'] = PlayerData.metadata['houserobberyxp'] or 0
    PlayerData.metadata['truckertrips'] = PlayerData.metadata['truckertrips'] or 0
    PlayerData.metadata['deliveryxp'] = PlayerData.metadata['deliveryxp'] or 0

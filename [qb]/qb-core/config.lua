...
QBConfig.DefaultSpawn = vector4(0, 0, 0, 0.0)
...
QBConfig.Player = {}
QBConfig.Player.MaxWeight = 125000 -- Max weight a player can carry (currently 120kg, written in grams)
QBConfig.Player.MaxInvSlots = 35 -- Max inventory slots for a player
...
QBConfig.Server.Discord = "https://discord.gg/TJXzEkm5Dw" -- Discord invite link

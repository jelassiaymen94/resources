...
local healing = false
local img = "inventory/html/images/"
-- Functions
...
--[[RegisterNetEvent('consumables:client:icetea', function(itemName)
...
RegisterNetEvent('consumables:client:UseParachute', function()
    ...
    QBCore.Functions.Progressbar("use_parachute", "parachute using..", 5000, false, true, {
        ...
        TriggerEvent('Polar-Clothing:client:loadOutfit', ParachuteData)
...
RegisterNetEvent('consumables:client:ResetParachute', function()
    if ParachuteEquiped then
        ...
        QBCore.Functions.Progressbar("reset_parachute", "Packing parachute..", 40000, false, true, {
            ...
            TriggerEvent('Polar-Clothing:client:loadOutfit', ParachuteRemoveData)
            TaskPlayAnim(ped, "clothingshirt", "exit", 8.0, 1.0, -1, 49, 0, 0, 0, 0)
...
RegisterNetEvent('consumables:client:Usepdarmor', function()
    ...
    QBCore.Functions.Progressbar("use_pdarmor", "Putting on body armour..", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
		disableMouse = false,
		disableCombat = true,
        ...
        if PlayerData.charinfo.gender == 0 then
            ...
            if GetPedDrawableVariation(ped, 9) == 7 then
               -- SetPedComponentVariation(ped, 9, 19, GetPedTextureVariation(ped, 9), 0)
            else
               -- SetPedComponentVariation(ped, 9, 14, 0, 0) -- Blue
            end
        else
        ...
        TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["pdarmor"], "remove")
        TriggerServerEvent("QBCore:Server:RemoveItem", "pdarmor", 1)
...
RegisterNetEvent('consumables:client:ResetArmor', function()
    ...
    if currentVest ~= nil and currentVestTexture ~= nil then
        QBCore.Functions.Progressbar("remove_armor", "Removing the body armour..", 2500, false, true, {
            ...
            SetPedArmour(ped, 0)
            TriggerEvent("inventory:client:ItemBox", QBCore.Shared.Items["pdarmor"], "add")
            TriggerServerEvent("QBCore:Server:AddItem", "pdarmor", 1)
        end)
    else
...
--[[RegisterNetEvent('consumables:client:mtdew', function(itemName)
    TriggerEvent('animations:client:EmoteCommandStart', {"soda"})
    QBCore.Functions.Progressbar("drink_something", "Drinking cola", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
...
RegisterNetEvent('consumables:client:drpepper', function(itemName)
    TriggerEvent('animations:client:EmoteCommandStart', {"soda"})
    QBCore.Functions.Progressbar("drink_something", "Drinking cola", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
...
RegisterNetEvent('consumables:client:barqs', function(itemName)
    TriggerEvent('animations:client:EmoteCommandStart', {"soda"})
    QBCore.Functions.Progressbar("drink_something", "Drinking cola", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,
...
RegisterNetEvent('consumables:client:fanta', function(itemName)
    TriggerEvent('animations:client:EmoteCommandStart', {"soda"})
    QBCore.Functions.Progressbar("drink_something", "Drinking cola", 5000, false, true, {
        disableMovement = false,
        disableCarMovement = false,

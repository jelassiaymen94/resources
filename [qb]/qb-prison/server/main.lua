...
RegisterNetEvent('Polar-Prison:Server:Search', function()
    local chance = math.random(1,100)

    if chance >= 25 then


    elseif chance < 15 and chance > 10 then


    elseif chance < 10 and chance > 2 then
...
RegisterNetEvent('Polar-Prison:Server:ResetTime', function()

    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if not Player then return end
    Player.Functions.SetMetaData("injail", 1)

...
Config.Elevators = {
    ...
    ["conkersave"] = {
        ...
        Floors = {
            [1] = {
                Label = "Conker Inside",
                FloorDesc = "Conker Inside",
                Restricted = true,
                Coords = vector3(373.5451, 423.4785, 145.9079),
                ExitHeading = "145.7197"
            },
            [2] = {
                Label = "Entrance",
                FloorDesc = "Entrance",
                Coords = vector3(384.9212, 426.3344, 144.2039),
                ExitHeading = "354.8159"
            },			
        }
    },
...
--1088.16, -3187.18, -38.85
    ...
    [195] = { name = "Police Entrance", location = vector3(459.4321, -1008.6608, 28.2625), width = 0.5, length = 2.8, heading = 209.3, minz = 27.5290 - 1, maxz = 29.5290 + 1.5 },
    ...
    --[198] = { name = "Conker Inside", location = vector3(372.3565, 424.0916, 146.4000), width = 0.5, length = 0.8, heading = 72.3, minz = 145.0005 - 1, maxz = 147.0005 + 1.5 },
    [199] = { name = "Conker Entrance", location = vector3(386.5104, 428.4020, 144.4038), width = 0.5, length = 0.8, heading = 258.3, minz = 143.5290 - 1, maxz = 145.5290 + 1.5 },
    [200] = { name = "Conker Inside", location = vector3(372.3565, 424.0916, 146.4000), width = 0.5, length = 0.8, heading = 258.3, minz = 145.5290 - 1, maxz = 147.5290 + 1.5 },

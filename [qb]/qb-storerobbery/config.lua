...
Config.Safes = {
    ...
    [4] = {vector4(-709.74, -904.15, 19.21, 229.5), type = "keypad", robbed = false, camId = 7}, -- right
    [5] = {vector3(31.19, -1339.25, 29.5), type = "keypad", robbed = false, camId = 8}, -- fixed
    [6] = {vector3(1126.77, -980.1, 45.41), type = "padlock", robbed = false, camId = 9}, -- right
    [7] = {vector3(1159.46, -314.05, 69.2), type = "keypad", robbed = false, camId = 10}, -- good
    [8] = {vector3(381.02, 332.52, 103.57), type = "keypad", robbed = false, camId = 11},
    ...
    [12] = {vector3(-3249.69, 1007.36, 12.83), type = "keypad", robbed = false, camId = 15},
    [13] = {vector3(543.78, 2662.52, 42.16), type = "keypad", robbed = false, camId = 16},
    [14] = {vector3(1169.31, 2717.79, 37.15), type = "padlock", robbed = false, camId = 17},
    [15] = {vector3(2674.31, 3289.18, 55.24), type = "keypad", robbed = false, camId = 18},
    [16] = {vector3(1961.81, 3750.38, 32.34), type = "keypad", robbed = false, camId = 19}, -- done
    [17] = {vector3(1737.44, 6419.43, 35.04), type = "keypad", robbed = false, camId = 20},
    [18] = {vector3(-168.40, 6318.80, 30.58), type = "padlock", robbed = false, camId = 27},
    [19] = {vector3(170.96, 6642.55, 31.7), type = "keypad", robbed = false, camId = 30},
}

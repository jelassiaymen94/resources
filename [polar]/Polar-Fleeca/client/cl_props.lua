...
RegisterNetEvent('Polar-fleeca:Client:DestroyPad', function(number)
   if number == 'fleecadoor1' then switch(keypad1, Config.Door1Eye, 1) end
   if number == 'fleecadoor2' then switch(keypad2, Config.Door2Eye, 2) end
   if number == 'fleecadoor3' then switch(keypad3, Config.Door3Eye, 3) end
end)
...
RegisterNetEvent('Polar-fleeca:Client:ResetPropsKeypads', function()

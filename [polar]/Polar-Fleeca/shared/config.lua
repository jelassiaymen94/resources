...
Config.BlipName = "fleeca Bank" -- blip name
...
Config.FingerPrintDoorDoor = 'fleecafinger'

Config.fleeca = true
Config.VaultDoorAnimation = vector4(-102.2, 6463.14, 31.63, 214.89)
Config.VaultDoorDoor = 'fleecavault'

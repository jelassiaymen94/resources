...
function DisplayMenu(state, slider1, slider2, slider3, slider4, slider5, slider6,slider7, startPos)
    if state then
            ...
            {
                {
                    ...
                    items = 
                    {
                        ...
                        {name = "w_kf", type_1 = "normal", label_1 = "Wheel Camber Front", sliderItems_1 = {}, type_2 = "slider", label_2 = "", sliderItems_2 = slider6, sliderStartPos = startPos[6]},
                        {name = "w_kr", type_1 = "normal", label_1 = "Wheel Camber Rear", sliderItems_1 = {}, type_2 = "slider", label_2 = "", sliderItems_2 = slider7, sliderStartPos = startPos[6]}
                    }
                },
                {

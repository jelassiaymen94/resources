...
Config.paletoprop40 = {
    vector4(-100.63, 6466.6, 31.63, 316.0), --- locations, can be multiple but chooses 1 at random
...
function bruhppp(door, prop, location)
    ...
    TriggerClientEvent('Polar-Paleto:Client:AddPaintTarget', -1, door,  prop, vec4(location.x, location.y, location.z+0.2, location.w))

...
function starttarget()
    if target == 'ox' then
        ...
        local name = labs[labname["mix"]]
        exports['qb-target']:AddBoxZone(name, Config.MixLocation, 1, 1, { name = "mix", heading = 0.0, debug = Config.Debug, minZ = Config.MixLocation.z-1, maxZ =  Config.MixLocation.z+1,}, 

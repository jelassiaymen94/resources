...
function starttarget(labname2)
    if target == 'ox' then
        ...
        exports['qb-target']:AddBoxZone(labs["first"] .. "mix", Config.MixLocation, 1, 1, { name = "mix", heading = 0.0, debug = Config.Debug, minZ = Config.MixLocation.z-1, maxZ =  Config.MixLocation.z+1,}, 

...
function hitup(bool)
    ...
    if item == 'lockpick' then
        -- 3(amount of items), 1(xp), 1(giveamount), item(no toucch), mat1, mat1amount, mat2, mat2amount, mat3, mat3amount etc.
        removeitem(3, 1, 1, item, 'metalscrap', 3, 'plastic', 2, 'rubber', 1) -- done***
        
    elseif item == 'screwdriverset' then
      
        removeitem(3, 1, 1, item, 'iron', 4, 'metalscrap', 4, 'steel', 2) -- done***
              
    elseif item == 'armor' then

        removeitem(2, 1, 1, item, 'carbon', 2, 'steel', 15) -- done***
    ...
    elseif item == 'weapon_sledgehammer' then
        ...
        removeitem(3, 1, 1, item, 'iron', 15, 'steel', 5, 'rubber', 5) -- done***

    elseif item == 'weapon_flare' then

        removeitem(2, 1, 1, item, 'plastic', 20, 'aluminumoxide', 1) -- done***

    elseif item == 'metalscratchy' then

        removeitem(2, 1, 1, item, 'metalscrap', 10, 'iron', 10) -- done***

    elseif item == 'electronickit' then

        removeitem(3, 1, 1, item, 'refined_iron', 1, 'goldingot', 1, 'plastic', 5) -- done***

    elseif item == 'keypad' then

        removeitem(3, 1, 1, item, 'electronickit', 2, 'plastic', 5, 'rubber', 2) -- done***

    elseif item == 'weapon_knuckle' then

        removeitem(2, 1, 1, item, 'refined_steel', 2, 'goldingot', 2) -- done***

    elseif item == 'gunpowder' then

        removeitem(2, 1, 10, item, 'aluminumoxide', 1, 'charcoal', 25) -- done

    elseif item == 'pistol_ammo' then

        removeitem(2, 1, 1, item, 'copperore', 2, 'gunpowder', 1) -- done***

    elseif item == 'weapon_fnx45' then

        removeitem(6, 1, 1, item, 'refined_iron', 1, 'refined_aluminum', 1, 'pistolbarrel', 1, 
        'pistolbody', 1, 'pistolgrip', 1, 'copper', 4) -- done

    elseif item == 'ironoxcidepowder' then

        removeitem(4, 1, 1, item, 'glass', 15, 'gunpowder', 2, 'plastic', 1, 'refined_iron', 1) -- done

    elseif item == 'aluminumoxide' then

        removeitem(4, 1, 1, item, 'glass', 20, 'plastic',1, 'copper', 5, 'refined_aluminum', 1) -- done

    elseif item == 'thermitepowder' then

        removeitem(4, 1, 1, item, 'glass', 5, 'plastic', 1, 'ironoxcidepowder', 1, 'aluminumoxide', 1) -- done

    elseif item == 'thermite' then

        removeitem(2, 1, 1, item, 'refined_plastic', 4, 'thermitepowder', 1) -- done

    elseif item == 'weapon_smokegrenade' then
        
        removeitem(4, 1, 1, item, 'carbon', 1, 'charcoal', 5, 'aluminum', 5, 'thermitepowder', 1) -- done***

    elseif item == 'weapon_pipebomb' then

        removeitem(4, 1, 1, item, 'gunpowder', 10, 'refined_aluminum', 2, 'rubber', 3, 'thermitepowder', 1)  -- done***

    elseif item == 'weapon_grenade' then

        removeitem(4, 1, 1, item, 'metalscrap', 6, 'refined_aluminum', 2, 'thermitepowder', 2, 'refined_iron', 1)  -- done***

    elseif item == 'weapon_molotov' then

        removeitem(3, 1, 2, item, 'weapon_petrolcan', 2, 'bottle', 2, 'cloth', 1)  -- done***

    elseif item == 'handcuffs' then

        removeitem(3, 1, 1, item, 'metalscrap', 5, 'refined_steel', 5, 'refined_iron', 1)  -- done***

    elseif item == 'smg_ammo' then

        removeitem(2, 1, 1, item, 'gunpowder', 2, 'copperore', 4) -- done***

    elseif item == 'weapon_microsmg3' then

        removeitem(6, 1, 1, item, 'refined_iron', 2, 'refined_copper', 2, 'smgbarrel', 1, 'smgbody', 1, 'smggrip', 1, 'rubber', 5)-- done***

    elseif item == 'weapon_microsmg2' then

        removeitem(6, 1, 1, item, 'refined_steel', 3, 'smgbarrel', 1, 'smgbody', 1, 'smggrip', 1, 'rubber', 5, 'refined_copper', 2)-- done***

    elseif item == 'weapon_pistol50' then

        removeitem(6, 1, 1, item, 'refined_steel', 5, 'refined_aluminum', 5, 'pistolbarrel', 1, 'pistolbody', 1, 'pistolgrip', 1, 'rubber', 1)-- done***
             
    elseif item == 'rifle_ammo' then

        removeitem(2, 1, 1, item, 'copperore', 3, 'gunpowder', 6)

    elseif item == 'weapon_assaultrifle2' then

        removeitem(7, 1, 1, item, 'carbon', 5, 'riflereciever', 1, 'rifletrigger', 1, 'riflegrip', 1, 'refined_aluminum', 1, 'refined_steel', 1, 'rubber', 5, 'refined_copper', 1)

    elseif item == 'weapon_assaultrifle' then

        removeitem(7, 1, 1, item, 'carbon', 10, 'riflereciever', 5, 'rifletrigger', 1, 'riflegrip', 1, 'refined_aluminum', 1, 'refined_steel', 1, 'rubber', 5, 'refined_copper', 1)
